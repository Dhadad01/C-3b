...
// Define a new type called "compare_func_t" for a function that receives two pointers to "data_t"
...
typedef struct MarkovNode{
    void *data;//current word
    int overall_prob;//overall appears of _void_ after data
    int length_words_after;//overall _void_ that appeared after data
    struct NextNodeCounter* counter_list;//words and frequent list
}MarkovNode;
